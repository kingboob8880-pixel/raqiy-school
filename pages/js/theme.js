...
// а "pattern" — «Свет» (2026-07-27: песочный «Пергамент» заменён на белый
// с холодным холстом, автор: «пусть светлая тема будет светлой»).
...
export const SITE_THEMES = [
  ...
  { key: "pattern", label: "Свет", layout: "centered" },
