...
const S = {
  ...
  "authErr.emailInUse":     { ru: "Этот email уже зарегистрирован — попробуйте войти вместо регистрации.", en: "This email is already registered — try signing in instead.", uz: "Bu email allaqachon ro'yxatdan o'tgan — ro'yxatdan o'tish o'rniga kiring." },
  "authErr.badEmail":       { ru: "Проверьте формат email.", en: "Check the email format.", uz: "Email formatini tekshiring." },
  "authErr.weakPassword":   { ru: "Пароль слишком простой — минимум 6 символов.", en: "Password is too weak — at least 6 characters.", uz: "Parol juda oddiy — kamida 6 belgi." },
  "authErr.noUser":         { ru: "Ученик с таким email не найден — проверьте адрес или зарегистрируйтесь.", en: "No student with this email — check the address or sign up.", uz: "Bunday email bilan o'quvchi topilmadi — manzilni tekshiring yoki ro'yxatdan o'ting." },
  "authErr.wrongPassword":  { ru: "Неверный пароль.", en: "Wrong password.", uz: "Parol noto'g'ri." },
  "authErr.badCredentials": { ru: "Неверный email или пароль.", en: "Wrong email or password.", uz: "Email yoki parol noto'g'ri." },
  "authErr.tooMany":        { ru: "Слишком много попыток — подождите немного и попробуйте снова.", en: "Too many attempts — wait a moment and try again.", uz: "Urinishlar juda ko'p — biroz kutib, qayta urinib ko'ring." },
  "authErr.noNetwork":      { ru: "Нет связи с сервером — проверьте интернет-соединение.", en: "No connection to the server — check your internet.", uz: "Server bilan aloqa yo'q — internetni tekshiring." },
  "authErr.profileLater":   { ru: "Аккаунт создан, но анкета не сохранилась. Просто войдите по этой же почте и паролю — всё дозаполнится.", en: "Your account was created but the profile did not save. Just sign in with the same email and password — it will finish setting up.", uz: "Hisob yaratildi, ammo anketa saqlanmadi. Shu email va parol bilan kiring — qolgani o'zi to'ldiriladi." },
  "authErr.generic":        { ru: "Что-то пошло не так. Попробуйте ещё раз чуть позже.", en: "Something went wrong. Please try again in a moment.", uz: "Nimadir noto'g'ri ketdi. Birozdan keyin qayta urinib ko'ring." },
  "theme.label":       { ru: "Тема:", en: "Theme:", uz: "Mavzu:" },
  "theme.emerald":     { ru: "Изумруд", en: "Emerald", uz: "Zumrad" },
  "theme.light":       { ru: "Свет", en: "Light", uz: "Yorug'" },
  "theme.graphite":    { ru: "Графит", en: "Graphite", uz: "Grafit" },
  "landing.badge":     { ru: "Курс от лекаря Абу Мухаммада", en: "A course by the healer Abu Muhammad", uz: "Shifokor Abu Muhammad kursi" },
  "landing.title":     { ru: "Стань полноценным заклинателем — от убеждённости сердца до приёма пациентов", en: "Become a complete raqi — from certainty of the heart to seeing patients", uz: "To'liq roqiy bo'ling — qalb yaqinidan bemor qabuligacha" },
  "landing.lead":      { ru: "12 модулей: от основ якына и подлинных хадисов о рукье до итоговой практики под супервизией наставника и работы в системе диагностики и лечения RUKYA Pro.", en: "12 modules: from the foundations of yaqin and authentic hadiths on ruqyah to final practice under a mentor's supervision and work in the RUKYA Pro system.", uz: "12 modul: yaqin asoslari va ruqya haqidagi sahih hadislardan ustoz nazorati ostidagi yakuniy amaliyot va RUKYA Pro tizimida ishlashgacha." },
  "landing.ctaFree":   { ru: "Читать бесплатные отрывки", en: "Read free excerpts", uz: "Bepul parchalarni o'qish" },
  "landing.ctaBuy":    { ru: "Купить курс — 30 000 ₽", en: "Buy the course — 30,000 ₽", uz: "Kursni sotib olish — 30 000 ₽" },
  "landing.ayah":      { ru: "«…то, что является исцелением и милостью для верующих»", en: "\u201c…that which is healing and mercy for the believers\u201d", uz: "\u201c…mo'minlar uchun shifo va rahmat bo'lgan narsa\u201d" },
  "landing.ayahSrc":   { ru: "Сура аль-Исра · 17:82", en: "Surah al-Isra \u00b7 17:82", uz: "Al-Isro surasi \u00b7 17:82" },
  "landing.f1t":       { ru: "Только проверенные источники", en: "Verified sources only", uz: "Faqat tekshirilgan manbalar" },
  "landing.f1":        { ru: "Каждый фрагмент курса промаркирован: прямая цитата Корана/Сунны, устоявшаяся практика, или авторский метод — открыто, без выдачи одного за другое.", en: "Every part of the course is labelled: a direct quote from Quran or Sunnah, established practice, or the author's own method — stated openly, never one passed off as another.", uz: "Kursning har bir qismi belgilangan: Qur'on yoki Sunnadan to'g'ridan-to'g'ri iqtibos, o'rnashgan amaliyot yoki muallif usuli — ochiq, biri ikkinchisi o'rniga berilmaydi." },
  "landing.f2t":       { ru: "Безопасность пациента — не опция", en: "Patient safety is not optional", uz: "Bemor xavfsizligi — majburiy" },
  "landing.f2":        { ru: "Диагностика — никогда через боль/надавливание. Страдание пациента — никогда не игнорируется. Это встроено в курс, а не добавлено потом.", en: "Diagnosis is never done through pain or pressure. A patient's suffering is never ignored. This is built into the course, not added afterwards.", uz: "Tashxis hech qachon og'riq yoki bosim orqali qo'yilmaydi. Bemorning azobi hech qachon e'tiborsiz qoldirilmaydi. Bu kursga dastlabdan kiritilgan." },
  "landing.f3t":       { ru: "От теории к практике", en: "From theory to practice", uz: "Nazariyadan amaliyotga" },
  "landing.f3":        { ru: "Финальные модули — разбор реальных кейсов под супервизией и работа в системе RUKYA Pro, где выпускник ведёт приём настоящих пациентов.", en: "The final modules cover real cases under supervision and work in the RUKYA Pro system, where the graduate sees actual patients.", uz: "Yakuniy modullar — nazorat ostida haqiqiy holatlar tahlili va RUKYA Pro tizimida ishlash, bitiruvchi haqiqiy bemorlarni qabul qiladi." },
  ...
  "modules.subtitle":  { ru: "12 модулей · от основ к самостоятельному приёму", en: "12 modules · from basics to independent practice", uz: "12 modul · asoslardan mustaqil amaliyotga" },
  ...
  "auth.writeTg":      { ru: "Написать лекарю в Telegram", en: "Message the healer on Telegram", uz: "Telegramda shifokorga yozish" },
  ...
  "ach.halfway.d":     { ru: "Пройти 6 модулей из 11", en: "Complete 6 out of 12 modules", uz: "12 dan 6 ta modulni yakunlash" },
  ...
  "ach.graduate.d":    { ru: "Завершить все 12 модулей курса", en: "Complete all 12 course modules", uz: "Kursning barcha 12 modulini yakunlash" },
  ...
  // Программу больше не скачивают с сайта — её присылает лекарь в Telegram
  // (решение автора, 2026-07-26). Поздравление переехало сюда, в текст
  // блока: раньше оно жило в модалке, которая всплывала в момент начала
  // скачивания. Ключи dash.congrats* удалены вместе с модалкой — она была
  // их единственным потребителем.
  "dash.rukyaProNote": { ru: "Вы прошли обучение и теперь можете принимать пациентов. Пусть Аллах сделает вас причиной исцеления людей и примет ваши усилия. Программа работает офлайн, без браузера — все данные хранятся только на вашем компьютере.", en: "You have completed the training and can now see patients. May Allah make you a means of healing and accept your efforts. The software works offline, no browser needed — all data stays on your computer.", uz: "Siz ta'limni yakunladingiz va endi bemorlarni qabul qilishingiz mumkin. Alloh sizni odamlarni davolash sababchisi qilsin va harakatlaringizni qabul qilsin. Dastur oflayn ishlaydi, brauzer kerak emas — barcha ma'lumotlar faqat kompyuteringizda saqlanadi." },
  "dash.rukyaProBtn":  { ru: "Запросить программу в Telegram →", en: "Request the software on Telegram →", uz: "Telegramda dasturni so'rash →" },
  "dash.rukyaProSS":   { ru: "Лекарь пришлёт установщик лично. При первом запуске Windows может показать предупреждение SmartScreen — нажмите «Подробнее» → «Выполнить в любом случае».", en: "The healer will send you the installer personally. On first launch Windows may show a SmartScreen warning — click \"More info\" → \"Run anyway\".", uz: "Tabib o'rnatuvchini shaxsan yuboradi. Birinchi ishga tushirishda Windows SmartScreen ogohlantirishini ko'rsatishi mumkin — \"Batafsil\" → \"Baribir ishga tushirish\" tugmasini bosing." },
  ...
  "landing.path.title": { ru: "Путь ученика — все 12 модулей", en: "Student's Path — all 12 modules", uz: "Talaba yo'li — barcha 12 modul" },
  "landing.exams.title": { ru: "Экзамены и сертификат", en: "Exams and Certificate", uz: "Imtihonlar va sertifikat" },
  "landing.exams.text":  { ru: "После каждой прочитанной книги — короткий экзамен по ней самой (порог 70%), не общий тест «по всему сразу». После каждого модуля — итоговый тест. Все экзамены и их статус собраны на одной странице — «Тесты». Когда пройдены все 12 модулей, в кабинете открывается сертификат «Практик рукии» за подписью Абу Мухаммада — можно распечатать или сохранить как PDF.", en: "After each book — a short exam (70% threshold), not a general \"everything at once\" test. After each module — a final test. All exams and their status are on one page — \"Tests\". When all 12 modules are completed, a \"Ruqyah Practitioner\" certificate signed by Abu Muhammad opens in your dashboard — print or save as PDF.", uz: "Har bir kitobdan keyin — qisqa imtihon (70% chegara), umumiy \"barchasini bir yo'la\" test emas. Har bir moduldan keyin — yakuniy test. Barcha imtihonlar va ularning holati bitta sahifada — \"Testlar\". Barcha 12 modul yakunlanganda, Abu Muhammad imzolagan \"Ruqya amaliyotchisi\" sertifikati kabinetingizda ochiladi — chop etish yoki PDF sifatida saqlash mumkin." },
  ...
  "landing.blurb.7":    { ru: "Трилогия «Прямой путь — Заклинание верой» в одном модуле: намерение, обращение к Аллаху и целостная практика. С этого намерения и настроя лекарь входит в продвинутый уровень.", en: "The trilogy \"The Straight Path — Incantation by Faith\" in one module: intention, turning to Allah, and holistic practice. With this intention and mindset the healer enters the advanced level.", uz: "Uch kitoblik «To'g'ri yo'l — Imon bilan afsun» bir modulda: niyat, Allohyga murojaat va yaxlit amaliyot. Shu niyat va kayfiyat bilan tabib ilg'or bosqichga kiradi." },
  "landing.blurb.8":    { ru: "Что делать, если чтение встречает сопротивление — и обязательное правило немедленной остановки, если пациенту плохо.", en: "What to do when recitation meets resistance — and the mandatory rule to stop immediately if the patient feels unwell.", uz: "O'qish qarshilikka duch kelganda nima qilish kerak — va bemorga yomon bo'lsa darhol to'xtatish majburiy qoidasi." },
  "landing.blurb.9":    { ru: "Разбор реальных обезличенных кейсов с наставником и учебные сеансы под наблюдением — прежде чем принимать пациентов самостоятельно.", en: "Analysis of real anonymized cases with mentor and supervised training sessions — before seeing patients independently.", uz: "Ustoz bilan haqiqiy anonim holatlarni tahlil qilish va nazorat ostidagi o'quv seanslari — bemorlarni mustaqil qabul qilishdan oldin." },
  "landing.blurb.10":    { ru: "Богословские границы: единственность Истины и вопрос заступничества — где рукья остаётся в рамках акыды, а где выходит за них.", en: "Theological boundaries: uniqueness of Truth and the question of intercession — where ruqyah stays within aqeedah and where it crosses the line.", uz: "Ilohiyot chegaralari: Haqiqat yagonaligi va shafoat masalasi — ruqya aqida doirasida qayerda qoladi va qayerda chegaradan chiqadi." },
  "landing.blurb.11":   { ru: "Как отличить истинного заклинателя от того, кто наживается на чужой беде, не имея ни знания, ни богобоязненности.", en: "How to distinguish a true healer from one who profits from others' misfortune without knowledge or God-consciousness.", uz: "Haqiqiy tabibni bilim va taqvosiz boshqalarning baxtsizligidan foyda oladigan kishidan qanday ajratish mumkin." },
  "landing.blurb.12":   { ru: "Финальный практикум — приём пациентов через систему RUKYA Pro: диагноз алгоритма проверяется и подписывается самим раки.", en: "Final practicum — patient reception through RUKYA Pro: algorithm diagnosis is verified and signed by the raqi himself.", uz: "Yakuniy amaliyot — RUKYA Pro orqali bemorlarni qabul qilish: algoritm tashxisi roqiyning o'zi tomonidan tekshiriladi va imzolanadi." },
  ...
  "cert.desc":           { ru: "прошёл(-ла) полный курс подготовки заклинателя (раки) — 12 модулей, 25 книг, от основ убеждённости до итоговой практики под супервизией наставника.", en: "completed the full healer (raqi) training course — 12 modules, 25 books, from foundations of conviction to final practice under mentor supervision.", uz: "tabib (roqiy) tayyorlashning to'liq kursini yakunladi — 12 modul, 25 kitob, ishonch asoslaridan ustoz nazorati ostidagi yakuniy amaliyotgacha." },
  ...
  // Формулировки без «скачать»: программу теперь присылает лекарь в
  // Telegram, с сайта её больше не забирают (решение автора, 2026-07-26).
  "cert.proDesc":        { ru: "Курс завершён — теперь можно получить RUKYA PRO, рабочую программу для ведения пациентов (из Модуля 12). Работает офлайн, без браузера, все данные хранятся только на вашем компьютере.", en: "The course is complete — you can now get RUKYA PRO, a working program for patient management (from Module 11). Works offline, no browser needed, all data stays on your computer.", uz: "Kurs yakunlandi — endi RUKYA PRO ni olishingiz mumkin, bemorlarni boshqarish uchun ishchi dastur (11-moduldan). Oflayn ishlaydi, brauzer kerak emas, barcha ma'lumotlar faqat kompyuteringizda saqlanadi." },
  "cert.proRequest":     { ru: "Запросить программу в Telegram →", en: "Request the software on Telegram →", uz: "Telegramda dasturni so'rash →" },
  "cert.proSmartscreen": { ru: "Лекарь пришлёт установщик лично. При первом запуске Windows может показать предупреждение SmartScreen (программа новая, без платной цифровой подписи) — это ожидаемо, нужно нажать «Подробнее» → «Выполнить в любом случае».", en: "The healer will send you the installer personally. On first launch Windows may show a SmartScreen warning (new app, no paid digital signature) — this is expected, click \"More info\" → \"Run anyway\".", uz: "Tabib o'rnatuvchini shaxsan yuboradi. Birinchi ishga tushirishda Windows SmartScreen ogohlantirishini ko'rsatishi mumkin (yangi dastur, pullik raqamli imzo yo'q) — bu kutilgan holat, \"Batafsil\" → \"Baribir ishga tushirish\" tugmasini bosing." },
  ...
  "ml.paywallText":      { ru: "Полный текст, экзамен по нему и весь курс целиком — 12 модулей от основ якына до практики под супервизией наставника — открываются только после покупки курса.", en: "Full text, exam, and the entire course — 12 modules from yaqin basics to supervised practice — unlock only after purchasing the course.", uz: "To'liq matn, imtihon va butun kurs — yaqin asoslaridan ustoz nazorati ostidagi amaliyotgacha 12 modul — faqat kursni sotib olganidan keyin ochiladi." },
  ...
  // Намерение к упражнению (запрос автора 2026-07-27: «говорится о
  ...
  // ── Супервизия Модуля 12 (решение автора 2026-07-27) ──
  ...
  "sv.adminLead":      { ru: "Очередь разборов ваших учеников. Откройте любой — вы увидите все девять полей целиком и предыдущие разборы того же ученика. Заключение уходит ему и в кабинет, и в Telegram.", en: "Your students' cases awaiting review. Open any of them to see all nine fields in full plus that student's earlier cases. Your verdict reaches them both on the site and in Telegram.", uz: "O'quvchilaringizning tekshiruvdagi tahlillari. Istalganini oching — to'qqizta maydonni to'liq va o'sha o'quvchining oldingi tahlillarini ko'rasiz." },
  "sv.queue":          { ru: "Разборы на проверке", en: "Cases awaiting review", uz: "Tekshiruvdagi tahlillar" },
  "sv.queueLoading":   { ru: "Собираю очередь…", en: "Loading the queue…", uz: "Navbat yuklanmoqda…" },
  "sv.queueEmpty":     { ru: "Очередь пуста", en: "The queue is empty", uz: "Navbat bo'sh" },
  "sv.queueEmptyNote": { ru: "Как только ученик пришлёт разбор, он появится здесь — и придёт вам в Telegram.", en: "As soon as a student submits a case it will appear here — and in your Telegram.", uz: "O'quvchi tahlil yuborishi bilan u shu yerda paydo bo'ladi va Telegramingizga keladi." },
  "sv.caseN":          { ru: "Случай", en: "Case", uz: "Holat" },
  "sv.caseGone":       { ru: "Разбор не найден — возможно, ученик его отозвал.", en: "Case not found — the student may have withdrawn it.", uz: "Tahlil topilmadi — o'quvchi uni qaytarib olgan bo'lishi mumkin." },
  "sv.acceptedSoFar":  { ru: "Принято ранее", en: "Accepted so far", uz: "Avval qabul qilingan" },
  "sv.of":             { ru: "из", en: "of", uz: "dan" },
  "sv.prevCases":      { ru: "Предыдущие разборы этого ученика", en: "Earlier cases from this student", uz: "Bu o'quvchining oldingi tahlillari" },
  "sv.verdictLabel":   { ru: "Заключение наставника", en: "Mentor's verdict", uz: "Ustoz xulosasi" },
  "sv.verdictHint":    { ru: "Ученик прочитает его целиком — и в кабинете, и в Telegram. Напишите, что сделано верно и что исправить.", en: "The student will read it in full — both on the site and in Telegram. Say what was right and what to fix.", uz: "O'quvchi uni to'liq o'qiydi — saytda ham, Telegramda ham. Nima to'g'ri va nimani tuzatish kerakligini yozing." },
  "sv.verdictPlaceholder": { ru: "Например: опрос проведён полно, красные флаги проверены. Вывод сделан по впечатлению — вернитесь к признакам из Модуля 4 и обоснуйте…", en: "For example: the survey was thorough, red flags checked. The conclusion rests on impression — go back to the signs from Module 4…", uz: "Masalan: so'rov to'liq, qizil bayroqlar tekshirilgan. Xulosa taassurotga asoslangan — 4-modul belgilariga qayting…" },
  "sv.verdictRequired": { ru: "Напишите заключение — хотя бы несколько предложений. «Принято» без единого слова наставника это не супервизия, а кнопка.", en: "Write a verdict — at least a few sentences. \u201cAccepted\u201d without a word from the mentor is a button, not supervision.", uz: "Xulosa yozing — hech bo'lmaganda bir necha jumla. Ustoz so'zisiz \u201cqabul qilindi\u201d — bu nazorat emas, tugma." },
  "sv.accept":         { ru: "Принять разбор", en: "Accept the case", uz: "Tahlilni qabul qilish" },
  "sv.return":         { ru: "Вернуть на доработку", en: "Return for revision", uz: "Qayta ishlashga qaytarish" },
  "sv.acceptedOk":     { ru: "Принято. Ученик получил заключение.", en: "Accepted. The student has received the verdict.", uz: "Qabul qilindi. O'quvchi xulosani oldi." },
  "sv.acceptedPassed": { ru: "Принято. Ученик допущен к практике.", en: "Accepted. The student is cleared for practice.", uz: "Qabul qilindi. O'quvchi amaliyotga qo'yildi." },
  "sv.returnedOk":     { ru: "Возвращено на доработку. Ученик получил заключение.", en: "Returned for revision. The student has received the verdict.", uz: "Qayta ishlashga qaytarildi. O'quvchi xulosani oldi." },
  ...
  // Формулировка автора (2026-07-26) и положение Модуля 11, §3: исцеление
  ...
  "feed.graduate":    { ru: "{name} прошёл все 12 модулей курса", en: "{name} completed all 12 modules of the course", uz: "{name} kursning barcha 12 modulini tamomladi" },
  ...
  "path.subtitle":       { ru: "12 модулей · от основ к самостоятельному приёму", en: "12 modules · from the fundamentals to seeing patients", uz: "12 modul · asoslardan mustaqil qabulgacha" },
...
const MODULE_TITLES = {
  ...
  8:  { en: "Expulsion of Spiritual Entities", uz: "Ruhiy mavjudotlarni haydash" },
  9:  { en: "Advanced Master", uz: "Ilg'or usta" },
  10:  { en: "True vs False Incantation", uz: "Haqiqiy va soxta afsun" },
  11: { en: "True Healer vs False Healer", uz: "Haqiqiy tabib va soxta tabib" },
  12: { en: "Working with RUKYA Pro", uz: "RUKYA Pro tizimida ishlash" },
};
...
const LESSON_TITLES = {
  ...
  "/content/reference/allyazi-atributy.md": { en: "Allazi Attribute Catalog (Reference)", uz: "Allazi sifatları katalogi (Ma'lumotnoma)" },
  "/content/reference/zaklinaniya-na-organy-katalog-1.md": { en: "Magic-Affliction Catalog — Part 1: Trampled and Ingested (Reference)", uz: "Sehr tasnifi katalogi — 1-qism: basilgan va yeyilgan (Ma'lumotnoma)" },
  "/content/reference/zaklinaniya-na-organy-katalog-2.md": { en: "Magic-Affliction Catalog — Part 2: Separation, Love Spells, Insanity, Infertility (Reference)", uz: "Sehr tasnifi katalogi — 2-qism: ajralish, jilov, jinnonligh, bepushtlik (Ma'lumotnoma)" },
  "/content/reference/zaklinaniya-na-organy-katalog-3.md": { en: "Magic-Affliction Catalog — Part 3: Illness, Laziness, Evil Eye, Mass (Reference)", uz: "Sehr tasnifi katalogi — 3-qism: kasallik, dangasalik, ko'r tikish, ommaviy (Ma'lumotnoma)" },
  // Module 3
