...
const S = {
  ...
  "landing.lead":      { ru: "11 модулей: от основ якына и подлинных хадисов о рукье до итоговой практики под супервизией наставника и работы в системе диагностики и лечения RUKYA Pro.", en: "11 modules: from the foundations of yaqin and authentic hadiths on ruqyah to final practice under a mentor's supervision and work in the RUKYA Pro system.", uz: "11 modul: yaqin asoslari va ruqya haqidagi sahih hadislardan ustoz nazorati ostidagi yakuniy amaliyot va RUKYA Pro tizimida ishlashgacha." },
